    ...
    <nav class="bg-brand-dark/95 backdrop-blur-md fixed w-full z-50 border-b border-brand-gray transition-all duration-300" id="navbar">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-20 items-center">
                ...
                <div class="hidden md:flex items-center space-x-6 lg:space-x-8">
                    ...
                    <a href="productos.php" class="font-medium transition-colors hover:text-brand-accent <?= $current_page == 'productos.php' ? 'text-brand-accent' : 'text-gray-300' ?>">Productos</a>
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-brand-dark border-b border-brand-gray absolute w-full shadow-2xl">
            <div class="px-4 pt-2 pb-6 space-y-2 flex flex-col">
                ...
                <a href="productos.php" class="block px-3 py-3 text-base font-medium hover:text-brand-accent hover:bg-brand-gray rounded-md transition-colors <?= $current_page == 'productos.php' ? 'text-brand-accent bg-brand-gray/50' : 'text-gray-300' ?>">Productos</a>
